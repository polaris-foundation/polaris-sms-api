...
from dhos_sms_api.blueprint_api import api_blueprint
from dhos_sms_api.models.api_spec import dhos_sms_api_spec
...
def test_openapi(tmp_path: str, app: Flask) -> None:
    ...
    generate_openapi_spec(dhos_sms_api_spec, new_spec_path, api_blueprint)

    new_spec = yaml.safe_load(new_spec_path.read_bytes())
    existing_spec = Path(__file__).parent / "../dhos_sms_api/openapi/openapi.yaml"
